This folder contains the script files used to generate the experiment data included in Section 7.1 of the paper. Brief descriptions on the R files follow:
